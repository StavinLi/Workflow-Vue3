<template>
    <el-drawer :append-to-body="true" title="条件设置" v-model="visible" direction="rtl" class="condition_copyer" size="550px" :before-close="saveCondition"> 
        ...
        <div class="demo-drawer__content">
            <div class="condition_content drawer_content">
                ...
                <el-dialog title="选择条件" v-model="conditionVisible" width="480px" append-to-body class="condition_list">
